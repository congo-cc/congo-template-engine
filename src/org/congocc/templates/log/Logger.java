package org.congocc.templates.log;
...
public abstract class Logger
{
    ...
    {
        "org.congocc.templates.log.Logger", "Null",
        ...
        ClassNotFoundException
    {
        ...
        try
        {
            ...
            return (LoggerFactory)Class.forName("org.congocc.templates.log." + factoryType + "LoggerFactory").newInstance();
        }
